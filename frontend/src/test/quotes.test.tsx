...
const presentedRevision = {
  ...
  validUntil: '2026-09-21T10:00:00Z', expired: false, createdAt: '2026-09-14T09:00:00Z', createdBy: 'u1',
  items: [{ quoteItemRevisionId: 'ir1', displayOrder: 1 }],
}
const draftRevision = {
  id: 'r2', revisionNumber: 2, status: 'DRAFT', presentedAt: null, validUntil: null, expired: false,
...
test('detalhe mostra situação derivada de cada versão e o total decidível', async () => {
  ...
  // Somente a versão apresentada e não substituída entra no total.
