export const queryKeys = {
  ...
  automations: ['work-order-statuses', 'automations'] as const,
  ...
  stock: (params: object) => ['inventory', 'stock', params] as const,
  stockMovements: (productId: string, page: number) => ['inventory', productId, 'movements', page] as const,
